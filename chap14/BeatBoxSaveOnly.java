...
public class BeatBoxSaveOnly { // implements MetaEventListener
   ...
   /*
    * public class MyCheckBoxListener implements ItemListener { public void
    * itemStateChanged(ItemEvent ev) { // might add real-time removal or addition,
    * probably not because of timing } } // close inner class
    */
   ...
   /*
    * public void meta(MetaMessage message) { if (message.getType() == 47) {
    * sequencer.start(); sequencer.setTempoInBPM(bpm); } }
    */
